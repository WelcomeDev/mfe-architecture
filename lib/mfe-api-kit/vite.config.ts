...
/**
 * 1. Определиться, как нам сформировать наш permissionMap
 * 2. Согласны ли дизайнеры с тем, что пользователю не нужно видеть поле, если у него всего одна организация и выбирать ему не из чего. Уточнить этот вопрос у Олега Дейса
 */
